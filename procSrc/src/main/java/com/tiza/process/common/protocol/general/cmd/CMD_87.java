...
import com.tiza.process.common.support.entity.*;
...
@Service
public class CMD_87 extends GeneralDataProcess {
    ...
    public void parse(byte[] content, Header header) {
        GeneralHeader gnHeader = (GeneralHeader) header;
        ...
        toKafka(gnHeader, position, status, param);

        VehicleInfo vehicleInfo = (VehicleInfo) vehicleCacheProvider.get(gnHeader.getTerminalId());
