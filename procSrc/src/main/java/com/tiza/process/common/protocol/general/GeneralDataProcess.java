package com.tiza.process.common.protocol.general;
...
/**
 * Description: GeneralDataProcess
 * Author: DIYILIU
 * Update: 2017-08-03 19:15
 */

@Service
public class GeneralDataProcess implements IDataProcess {
    protected Logger logger = LoggerFactory.getLogger(this.getClass());
    protected int cmd = 0xFF;

    protected static GeneralParseHandler handler;
    ...
    public Header dealHeader(byte[] bytes) {
        ...
        return new GeneralHeader(cmd, length, terminalId,
    ...
    public void toKafka(GeneralHeader header, Position position, Status status) {
    ...
    public static void setHandle(GeneralParseHandler parseHandler) {
